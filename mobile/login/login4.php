...
<link rel="apple-touch-icon" sizes="180x180" href="../../assets/images/favivon-r.png">
<link rel="icon" type="image/png" href="../../assets/images/favivon-r.png" />
<?php if(isset($_SESSION['loginId'])){echo "<script>window.location.href='../home/';</script>"; } ?>
<style>
    body{background-image:url("../../assets/img/bg.jpg");  background-repeat: repeat; background-size: cover;}
...
<div id="preloader"><div class="spinner-border" style = "color: #242E53;" role="status"></div></div>
    ...
    <div class="page-content mt-2">
        ...
        <div class="card card-style">
            ...
            <div class="text-center">
                    ...
                    <h1 class="font-25 mb-3 text-white" id="accountname2"> <br/>  <a href="index.html" title="BillsArena"><img src="../../assets/images/billslogor.png" style="width: 150px; border-radius: 0 18px 0;" alt="billsarena"/></a></h1>
                ...
                <div class="px-2">
                    ...
                    <div class="input-style no-borders has-icon mb-4">
                        ...
                        <em>(required)</em>
                        <i class="fa fa-eye show-password-icon" id="" style="position: absolute; top: 50%; right: 10px; transform: translateY(-50%); cursor: pointer;" onclick="togglePasswordVisibility()"></i>
                    </div>
                    <script>
                    ...
                    <button type="submit" id="submit-btn" style="width: 100%; background-color: #242E53 ;" class="btn btn-full btn-l font-600 font-15" onmouseover="this.style.backgroundColor='#242E53'" onmouseout="this.style.backgroundColor='#242E53'">
                        Login
                    </button>
                    ...
                    <div class="row pt-5 mb-3">
                        ...
                        <div class="col-12 text-center font-15 mt-3">
                            <a class="text-white"<b>By BillsArena 2024</b></a>
                        </div>
                    </div>
