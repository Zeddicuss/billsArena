<script>
    $("document").ready(function(){
        ...
        $("#pinForm").submit(function(e){
            ...
            if($("#old-pin").val().length < 6){$(this).val(null); swal("Opps!!","Pin Length Should Be 6 Digits.","info"); return;}
            if($("#new-pin").val().length < 6){$(this).val(null); swal("Opps!!","Pin Length Should Be 6 Digits.","info"); return;}
            if($("#retype-pin").val().length < 6){$(this).val(null); swal("Opps!!","Pin Length Should Be 6 Digits.","info"); return;}
   ...
   $("#datapinForm").submit(function(e){
    ...
    function verifyNetwork(){
        ...
        {
            verNetwork="Unable to Identify Network! (Reasons - Number might be New SIM or NIN not connected or Uncompleted SIM Registration. Your Purchase might not go through.)";
        }
    ...
    function selectElectricityByIcon(name){
        $("option[providername]").removeAttr("selected");
        $("option[providername='"+name+"']").attr("selected","selected");
    }
