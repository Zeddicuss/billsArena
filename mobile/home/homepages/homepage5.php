...
<div class="card notch-clear rounded-0 mb-n5 mt-0" data-card-height="200" style="background-color:<?php echo $sitecolor; ?>;">
            <div class="card-body pt-4 mt-2 mb-n2">
                ...
                <h3 class=" font-17 float-end color-white">• Active </h3>
                    ...
                    <div class="splide__list" id="single-slider-1-list" style="transform: translateX(-624px);">
                            ...
                            <div class="splide__slide" id="single-slider-1-slide02" aria-hidden="true" tabindex="-1" style="width: 312px;">
                               <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="https://goocredit.mwb.ng/assets/Slide.png" />
                                </div>
                            </div>
                            
                            <div class="splide__slide splide__slide--clone" aria-hidden="true" tabindex="-1" style="width: 312px;">
                                <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="../../assets/img/ads/go1.png" />
                                </div>
                            </div>
                           
                            <div class="splide__slide" id="single-slider-1-slide02" aria-hidden="true" tabindex="-1" style="width: 312px;">
                               <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="../../assets/img/ads/re1.png" />
                                </div>
                            </div>
                            
                            <div class="splide__slide" id="single-slider-1-slide02" aria-hidden="true" tabindex="-1" style="width: 312px;">
                               <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="../../assets/img/ads/re3.png" />
                                </div>
                            </div>
                            ...
                            <div class="splide__slide" id="single-slider-1-slide03" aria-hidden="true" tabindex="-1" style="width: 312px;">
                               <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="../../assets/img/ads/re2.png" />
                                </div>
                            </div>
        ...
        <div class="card card-style mt-n3">
            <div class="content mb-2 mt-3">
                <div class="row text-center mb-0">
                    <a href="https://chat.whatsapp.com/FEjg9M0DvCk2hquv3z0ZMF" class="col-3 mt-2">
                        <span class="icon icon-l rounded-sm py-2 px-2" style="background:#f2f2f2;">
                            <img src="https://goocredit.mwb.ng/assets/Wa.jpg" width="45" height="45">
                        </span>
                    </a>
                    
                    <a href="https://mwb.ng" class="col-3 mt-2">
                        <span class="icon icon-l rounded-sm py-2 px-2" style="background:#f2f2f2;">
                            <img src="https://goocredit.mwb.ng/assets/add2.png" width="45" height="45">
                        </span>
                    </a>
                    
                    <a href="https://addvert24.net.ng/" class="col-3 mt-2">
                        <span class="icon icon-l rounded-sm py-2 px-2" style="background:#f2f2f2;">
                            <img src="https://goocredit.mwb.ng/assets/add3.png" width="45" height="45">
                        </span>
                    </a>
                    
                    <a href="https://app.smskonet.net.ng/login" class="col-3 mt-2">
                        <span class="icon icon-l rounded-sm py-2 px-2" style="background:#f2f2f2;">
                            <img src="https://goocredit.mwb.ng/assets/add4.png" width="45" height="45">
                        </span>
                    </a>
                </div>
            </div>
            ...
            <div class="content mb-3 mt-3">
               <div>
                ...
                <a href="referrals" class="col-4 mt-2">
                        ...
                        <p class="mb-0 pt-1 font-13">Invite/Earn</p>
                    </a>
                ...
                <a href="pricing" class="col-4 mt-2">
                    ...
                    <a href="https://c.mwb.ng/login" id="" data-menu="" class="col-4 mt-2">
                        <span class="icon icon-l shadow-l rounded-sm" style="color:#ef4600;">
                            <i class="fa fa-receipt  font-18"></i>
                        </span>
                        <p class="mb-0 pt-1 font-13">ExtraKollet</p>
                    </a>
                    
                    <a href="https://wa.link/tnc5id" class="col-4 mt-2">
                        <span class="icon icon-l shadow-l rounded-sm" style="color:#20C68D;">
                            <i class="fa fa-user  font-18"></i>
                        </span>
                        <p class="mb-0 pt-1 font-13">Customer Care</p>
                    </a>
                    
                    <a href="https://youtube.com/playlist?list=PLrSufz5-r5Y8_-0a08aY4IQuTNRkvVufb&si=3US5PR8B3o3uqUZF" id="" data-menu="" class="col-4 mt-2">
                        <span class="icon icon-l shadow-l rounded-sm" style="color:#00cc00;">
                            <i class="fa fa-arrow-up font-18"></i>
                        </span>
                        <p class="mb-0 pt-1 font-13">Tutorials</p>
                    </a>
                    
                    <a href="https://addvert24.net.ng/" id="" data-menu="" class="col-4 mt-2">
                        <span class="icon icon-l shadow-l rounded-sm" style="color:#a5e645;">
                            <i class="fa fa-barcode font-18"></i>
                        </span>
                        <p class="mb-0 pt-1 font-13">Free Advert</p>
                    </a>

                    <a href="https://trafficboost.net.ng/statistics" id="" data-menu="" class="col-4 mt-2">
                        <span class="icon icon-l shadow-l rounded-sm" style="color:#e82300;">
                            <i class="fa fa-phone  font-18"></i>
                        </span>
                        <p class="mb-0 pt-1 font-13">TrafficBoost</p>
                    </a>
                    
                    <a href="https://app.smskonet.net.ng/login" class="col-4 mt-2">
                        <span class="icon icon-l shadow-l rounded-sm" style="color:#00b6e8;">
                            <i class="fa fa-wifi  font-18"></i>
                        </span>
                        <p class="mb-0 pt-1 font-13">BulkSMS</p>
                    </a>
                    
                    <a href="https://tally.so/r/mR5qEd" id="" data-menu="" class="col-4 mt-2">
                        <span class="icon icon-l shadow-l rounded-sm" style="color:#023bf5;">
                            <i class="fa fa-receipt font-18"></i>
                        </span>
                        <p class="mb-0 pt-1 font-13">Virtual Account</p>
                    </a>
