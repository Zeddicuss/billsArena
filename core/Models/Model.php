<?php
	...
	class Model{
		...
		public static $dbName="billcgrz_billsarena"; //Database Name
		public static $username="billcgrz_billsarena"; // Database Username
		public static $password="@Passw0rd."; //Database Password

        public static $dbh;
        
		public $emailUsername="support@billsarenas.com"; //Support Email Address
		public $emailPassword="@Passw0rd."; //Support Email Password
